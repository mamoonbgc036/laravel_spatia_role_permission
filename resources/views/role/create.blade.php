        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                <div class="flex justify-between items-center p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    <h2>Role Create</h2>
                    @can('role list')
                    <a href="{{ route('role.index') }}" class="text-white bg-blue-500 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                        All Roles
                    </a>
                    @endcan
                </div>
                <form action="{{ route('role.store') }}" method="POST" class="p-4">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="flex gap-6 bg-white mb-6 px-6 py-4">
                        ...
                        <div class="ml-3 role-management-checkbox">
                            <input name="permissions[]" id="permission{{$permission->id}}" value="{{ $permission->id}}" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    {{-- <div class="flex flex-wrap gap-6 mb-4">
                        ...
                        <div class="lg:w-80 px-6 py-4 rounded-md shadow-sm dark:bg-gray-800 bg-white">
                            ...
                            <div class="focus:outline-none text-sm leading-normal pt-2 text-gray-500 dark:text-gray-200 ">
                                ...
                                <div class="ml-3 role-management-checkbox">
                                    <input name="permissions[]" id="permission_checkbox2" value="" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="permission_checkbox2" class="ml-2 text-lg text-gray-900 dark:text-gray-300">
                                        Lorem Ipsum Dollar set <br>
                                    </label>
                                </div>
